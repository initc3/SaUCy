...
examples =
    ...
    , ( "cons success"
      ...
      , (Right (), [("hd", VInt 1), ("tl", VList [VInt 2, VInt 3])])
      )
    ...
    , ( "cons success w/ nil list 2"
      , VList [VInt 1]
      , PCons (PVar "hd") (PVar "tl")
      , (Right (), [("hd", VInt 1), ("tl", VList [])])
      )
    , ( "cons fail"
      , VList [VInt 1, VInt 2]
      , PCons (PVar "hd") (PList [])
      , (Left (MatchFail (PList []) (VList [VInt 2])), [("hd", VInt 1)])
      )
    , ( "cons fail on nil"
      , VList []
      , PCons (PVar "hd") (PVar "tl")
      , (Left (MatchFail (PCons (PVar "hd") (PVar "tl")) (VList [])), [])
      )
    , ( "double cons"
      , VList [VInt 1, VInt 2]
      , PCons (PVar "a") (PCons (PVar "b") (PVar "c"))
      , (Right (), [("a", VInt 1), ("b", VInt 2), ("c", VList [])])
      )
