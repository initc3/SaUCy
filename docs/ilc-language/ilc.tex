...
{\Delta_1; \Gamma_1 |- \Let{e_1}{x}{e_2} : C => \Delta_3; \Gamma_3}
%
\and
%
\Infer{a-let!?}
...
{\Delta_1; \Gamma_1 |- \LetBang{v}{x}{e} : C => \Delta_3; \Gamma_3}
%
\and
%
\Infer{a-lam?}
{\Delta_1 ; \Gamma_1, x:A |- e : C => \Delta_2; \Gamma_2}
{\Delta_1 ; \Gamma_1 |- \lam{x} e : A -> C => \Delta_2; \Gamma_2}
%
\and
%
\Infer{a-app?}
...
{\Delta_1; \Gamma_1 |- e_1 \xFork e_2 : D => ???}
%
\and
%
\Infer{a-choice>}
{\Delta_1; \Gamma_1 |- e_1 : C => \Delta_2; \Gamma_2\\\\
\Delta_1; \Gamma_1 |- e_2 : C => \Delta_3; \Gamma_3
}
{\Delta_1; \Gamma_1 |- \eChoose{e_1, e_2} : C => ???}
%
\and
%
\Infer{a-seq}
...
\Delta_2; \Gamma_2 |- e_2 : C => \Delta_3; \Gamma_3\\\\
\Delta_3; \Gamma_3 |- e_3 : C => \Delta_4; \Gamma_4}
{\Delta_1; \Gamma_1 |- \If{e_1}{e_2}{e_3} : C => \Delta_4; \Gamma_4}
%
\and
%
\Infer{a-if?}
...
\Delta_3; \Gamma_3 |- e_2 : C => \Delta_4; \Gamma_4}
{\Delta_1; \Gamma_1 |- \If{v}{e_1}{e_2} : C => \Delta_4; \Gamma_4}
%
\and
%
\Infer{a-case?}
{\Delta_1; \Gamma_1 |- v : A_1 + A_2 => \Delta_2; \Gamma_2\\\\
\Delta_2; \Gamma_2,x_1:A_1 |- e_1 : => \Delta_3; \Gamma_3\\\\
\Delta_2; \Gamma_2,x_2:A_2 |- e_2 : C => \Delta_3; \Gamma_3}
{\Delta_1; \Gamma_1 |- \Case{v}{x_1}{e_1}{x_2}{e_2} : C => \Delta_3; \Gamma_3}
%
\and
%
\Infer{a-split?}
