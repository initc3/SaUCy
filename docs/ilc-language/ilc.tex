...
\Infer{thunk}
{\Delta; \Gamma |- e : \tau |> m}
{\Delta; \Gamma |- \thunk{e} : \tyU{\tau} |> \Vm}
%
\and
%
\Infer{force}
{\Delta; \Gamma |- e : \tyU{\tau} |> \Vm}
{\Delta; \Gamma |- \eForce{e} : \tau |> \Vm}
%
\and
%
\Infer{ref}
{\Delta; \Gamma |- e : \tau |> m}
{\Delta; \Gamma |- \Ref{e} : \tyM{\tau} |> \Vm}
%
\and
%
\Infer{deref}
{\Delta; \Gamma |- e : \tyM{\tau} |> \Vm}
{\Delta; \Gamma |- \Deref{e} : \tau |> \Vm}
%
\and
%
\Infer{assign}
{\Gamma(x) = \tyM{\tau} \\ \Delta, \Gamma |- e : \tau |> m}
{\Delta; \Gamma |- \Assign{x}{e} : \Unit |> \Vm}
\end{mathpar}
\end{figure}
