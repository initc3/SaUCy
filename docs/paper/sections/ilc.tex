...
channel endpoints (written $c$), and banged values.  ILC supports a fairly standard
...
%
We formally distinguish between the names of channel endpoints, Read$(d)$,
Write$(d)$, and the channel $d$ itself that binds them. (Though, we informally
