...
write arrows ($\tyArr{A}{\wm}{U}$). \todo{Explain why we need sendable types.}
...
\todo{Explain values, are lambdas a value?}
...
\begin{itemize}[leftmargin=*]
  ...
  \item \emph{Choice:} $\eChoice{e_1}{e_2}$ allows a process to continue as
    ...
    processes. \todo{What happens when neither subexpression reads?}
\end{itemize}
...
Configuration stepping consists of five \todo{new rules} rules, including a congruence
