...
To recap, the typing rules maintain that only one process is active at any given
...
\Infer{rdend}
{\ChTy(d) = S}
{\ChTy; \Delta; \Gamma |- \mathsf{Read}(d) : \tyRd{S}}
%
\and
%
\Infer{wrend}
{\ChTy(d) = S}
{\ChTy; \Delta; \Gamma |- \mathsf{Write}(d) : \tyWr{S}}
\end{mathpar}
This pair of rules establish the canonical forms for the types of channel
endpoints, $\tyRd{S}$ and $\tyWr{S}$. We use the metavariable $c$ to range over
these two canonical forms.
