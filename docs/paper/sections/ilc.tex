...
composition of the mode of $e_1$ and the mode of $e_2$. \todo{Although unrelated
to preventing write nondeterminism, the modes also prevent sequential write
composition (affecting the let and let! rules). This prevents processes from
getting ``stuck'' trying to write again immediately after giving away its
activation.}
