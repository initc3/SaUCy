...
they hold relevance for certain typing rules. We also want to point out that we
elide value mode derivations and ordinary type polymorphism to avoid clutter.
