...
things: the mode composition rules are given in
Figure~\ref{fig:mode-composition}, and value mode derivations and ordinary type
polymorphism are omitted to avoid clutter.
...
composition of the mode of $e_1$ and the mode of $e_2$. \todo{Something about
sequential composition, and maybe something about sequential writes getting
stuck but we don't care.}
