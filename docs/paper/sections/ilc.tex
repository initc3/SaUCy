...
denotes the sendable variants; on functions, it denotes a special ``write''
function.

The more interesting expressions are those
...
The typing rules for the functional fragment of ILC are fairly
standard.\footnote{For brevity, we elide the typing rules for sendable products
and sums, since they are analagous to the intuitionistic variants.} We comment
on the nonobvious rules, such as the ones for various forms of abstraction
(iabs, wabs, aabs) and application (wapp).
