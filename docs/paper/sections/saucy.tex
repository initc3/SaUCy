...
dubbed SaUCy. We adapt theory from UC to SaUCy and flesh out an implementation
and proof for universally composable commitments.
...
\begin{itemize}[leftmargin=*]
  ...
  \item \emph{Corruptions.} The possible corruption models are either party
    ...
    corrupt, which are defined in the following data declaration:
