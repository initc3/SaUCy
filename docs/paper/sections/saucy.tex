...
samples a random string $\sigma$ and two trapdoor pseudorandom generators (prgs
$\mathsf{pk}_0, \mathsf{pk}_1$). \todo{?}
...
(breaking the pseudorandomness of the trapdoor permutation\todo{?}).
