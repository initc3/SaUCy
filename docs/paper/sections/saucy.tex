...
\noindent Here, we have chosen a simple definition for polynomial time, which is
defined only for closed terms.  Hofheinz \etal~\cite{hofheinz2013polynomial}
present alternate definitions for polynomial time ITMs, which can have free
channels, and discuss their trade-offs.
