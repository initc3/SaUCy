...
Apart from this, we explain some of the main modeling choices and the consequences they have for the ILC implementation.
...
In a more realistic model, the parties would only be able to communicate over a network channel modeled as a functionality, $\F{\textsc{smt}}$ or $\F{\textsc{syn}}$~\cite{canetti2001universally}.
...
(breaking the pseudorandomness of \textsf{tdp}).
