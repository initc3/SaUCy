...
This can be instantiated concretely for execution (e.g., with an RSA-based function) and treated abstractly in the metatheory when we get to the reduction step in the proof.
