...
\begin{mathpar}
  ...
  \end{mathpar}
\end{definition}
where $\mathsf{id}_\pi$ is the \emph{dummy protocol}, which simply relays messages between the environment and the functionality.
...
%
Instantiation proofs in SaUCy follow the same rhythm as in UC. We start with a security
