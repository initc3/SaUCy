...
\begin{sketch}
  ...
  \begin{align*}
    ...
    D_{\mc{I}} &= D(\mathsf{execUC~\mc{Z}~(dummyP, dummyP)~fCom~simI})
  \end{align*}
  ...
  and $D_{\mc{R}}'$ reduces to breaking the pseudorandomness of \textsf{prg}
  ...
  pseudorandomness of \textsf{prg} (hence, $D_{\mc{R}}' \sim D_{\mc{I}}$). By the
  transitivity of indistinguishability, $D_{\mc{R}} \sim D_{\mc{I}}$. \todo{Relate
    to ILC.}
\end{sketch}
