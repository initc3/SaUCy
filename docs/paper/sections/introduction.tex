...
cryptography more broadly~\cite{cortier2011survey}.\todo{EasyCrypt is also worth
mentioning. EasyCrypt is a faithful embedding of computational cryptography, but
language is not well-suited to express distributed protocols.}
...
inference, and \todo{some} linearity inference. Polymorphism on modes is bounded
