...
resource, so there is a unique process being written to. Together, these give
ILC its central metatheoretic property of confluence. The only nondeterminism in
an ILC program is due to random coin tosses taken by processes, which have a
