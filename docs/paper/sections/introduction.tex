...
verify. \todo{Protocols and specs are also often underspecified or expose
  unexpected behavior, so they may not enjoy nice composition properties or
  their security proofs may be flawed.} So although the UC framework is widely
used as a tool for analysis, its modularity benefits have not been enjoyed in
practical implementations.

While previous works have focused on systematizing UC (or cryptographic analysis
