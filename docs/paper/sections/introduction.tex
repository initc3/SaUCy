...
complexity)~\cite{symbolicuc}, do not support message-passing concurrency for distributed protocols~\cite{easycrypt},
or are too expressive (allow for expressing nondeterminsm with no computational interpretation).
