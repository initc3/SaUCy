...
\todo{Get to the point sooner.} While UC security proofs admit strong
...
prove its security by \emph{reduction}, i.e., by relating bad execution traces
to a probabilistic polynomial time computation that breaks a computational
