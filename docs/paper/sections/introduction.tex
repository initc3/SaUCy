...
%However, this power and generality comes at the cost of UC
%formalization being quite complicated. On top of this, the UC framework exists
%primarily on paper, which makes proofs error-prone and verifying security claims
%difficult. In a nutshell, a UC proof involves showing that a protocol $\pi$
%securely realizes an ideal functionality $\mc{F}$.
