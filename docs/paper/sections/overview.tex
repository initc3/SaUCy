...
to an idealized protocol in which processes simply rely on a \emph{single
...
definition, whatever adversarial behavior that can take place there does not
translate to a break in security in the real world.
...
\todo{The big payoff of UC is modularity.}
