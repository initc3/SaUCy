...
functionality. In Figure~\ref{func:com} (left), we show
...
In Figure~\ref{func:com} (right), we define $\Func_{\textsc{com}}$ in ILC to
highlight some key features of the language, such as its affine and modal type
system. Keep in mind that the overarching feature of ILC is confluence, so many
of our design choices are for achieving this.\smallskip
