...
cryptography literature~\cite{canetti2001commitments}.\footnote{\todo{Only
    realizable in perfect model of communication.}} The functionality simply
...
To see these invariants in action, we run through the typing rules for fork,
...
later). \todo{Or maybe explain it now.}
\begin{mathpar}
\Infer{wr}
{\Delta_1; \Gamma |- e_1 : S\\
...
Having gone through several typing rules, we can now revisit \textsf{fCom} from
