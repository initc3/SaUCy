...
\myheader{Example: Secure coin flipping.} \todo{Update to include
  non-malleability property.} Suppose two untrusting parties, Alice
...
\myheader{Commitment functionality.} We can capture all of these properties at
...
m_3$. \todo{Explain fork. Removed seq.}
