...
\Pf{}{}{\textbf{Subcase}~\exists\Config{\Names'}{\Store}{\Procs'}~\textrm{s.t.}~\Config{\Names}{\Store}{\Procs}->\Config{\Names'}{\Store}{\Procs'}}{}
        ...
        \Pf{}{}{\qquad\quad\ProcNm{q} E[ \eWr{v}{\eChan{c_2}}] \in \pi}{By $c_2 \leadsto c_1$}
...
%    \end{llproof}
  ...
  \item[] \textbf{Case}
    ...
    \begin{llproof}
      \Pf{\ChTy}{|-}{\Config{\Names}{\Store}{\Procs, \ProcNm{p} E_1[
            ...
            \eWr{v}{\eChan{c_2}}]} : \PrTy~\textrm{s.t.}}{}
  ...
  \item[] \textbf{Case}
    ...
    \end{mathpar}
    \begin{llproof}
      \Pf{\ChTy}{|-}{\Config{\Names}{\Store}{\Procs, \ProcNm{p} E_1[\eChoicee{c_1}{x_1}{e_1}{c_2}{x_2}{e_2}], \ProcNm{q} E_2[ \eWr{v}{\eChan{c}}]} : \PrTy~\textrm{s.t.}}{}
      \Pf{}{}{\quad\{ \PrTy(x) \mid x:e \in \pi\} = \PrTy_{\pi},~\PrTy(p) =
        U_{p},~\PrTy(q) = U_{q}}{Assumption}
