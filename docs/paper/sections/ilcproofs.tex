...
%            \eWr{\eChan{c_2}}{v}]} : \PrTy}{Assumption}
      ...
      \Pf{}{}{\mathcal{D}_1~\textrm{is a derivation of}~\Delta_1,\Delta_1';\Gamma_1,\Gamma_1'|-
        E_1[R[ \eLetRd{\eChan{c_1}}{x}{e}] ] : V_1,}{}
      \Pf{}{}{\quad\mathcal{D}_1'~\textrm{is a subderivation
          of}~\mathcal{D}_1~\textrm{concluding}~\Delta_1';\Gamma_1'|-
        \eLetRd{\eChan{c_1}}{x}{e} : V_1',}{}
      \Pf{}{}{\quad\textrm{the position of}~\mathcal{D}_1'~\textrm{corresponds to
          position of}~\mathcal{D}_1~\textrm{in}~E_1}{Assumption}

      \Pf{}{}{\mathcal{D}_2~\textrm{is a derivation of}~\Delta_2,\Delta_2';\Gamma_2,\Gamma_2'|-
        E_2[\eWr{\eChan{c_2}}{v}] : V_2,}{}
      \Pf{}{}{\quad\mathcal{D}_2'~\textrm{is a subderivation
          of}~\mathcal{D}_2~\textrm{concluding}~\Delta_2';\Gamma_2'|-
        \eWr{\eChan{c_2}}{v} : V_2',}{}
      \Pf{}{}{\quad\textrm{the position of}~\mathcal{D}_2'~\textrm{corresponds to
          position of}~\mathcal{D}_2~\textrm{in}~E_2}{Assumption}

      \Pf{}{}{c_2 \leadsto c_1~\text{s.t.}~c_2 : \tyWr{S}~\textrm{and}~c_1 : \tyRd{S}}{Given}      

      \Pf{\Delta_1';\Gamma_1',x : \tyTensor{\tyBang{S}}{\tyRd{S}}}{|-}{e : V_1'}{By
        inversion (rd)}
      ...
      \Pf{\Delta_1';\Gamma_1'}{|-}{\ePair{!v}{\eChan{c_1}}{1}/x]e : V_1'}{By
          Lemma~\ref{lem:sub-aff} (Substitution)}

      \Pf{\Delta_1,\Delta_1';\Gamma_1,\Gamma_1'}{|-}{E_1[ [\ePair{!v}{\eChan{c_1}}{1}/x]e] : V_1}{By
      ...
      \Pf{\Delta_2,\Delta_2';\Gamma_2,\Gamma_2'}{|-}{E_2[ \eUnit ] : V_2}{By
        Lemma~\ref{lem:replacement} (Replacement)}
...
%        E_2[ \eUnit ]} : \PrTy'}{By type preservation of $\pi,p,q$}
    \end{llproof}
%    \begin{llproof}
%      \Pf{\ChTy}{|-}{\Config{\Names}{\Store}{\Procs, \ProcNm{p} E_1[R[
%              \eLetRd{\eChan{c_1}}{x}{e}]], \ProcNm{q} E_2[
