    ...
    \item[] \textbf{Case}
      ...
      \begin{llproof}
        ...
        \Pf{}{}{\JCterm{\Config{\Names}{\Store}{\Procs}}~\textrm{or}~\exists
          ...
          i.h.}
       \Pf{}{}{\textbf{Subcase}~\exists~\Config{\Names'}{\Store}{\Procs',p:e'}~\textrm{s.t.}~\Config{\Names}{\Store}{p:e}->\Config{\Names'}{\Store}{\Procs',p:e'}}{\todo{Check}}
        \Pf{}{}{\quad e -> e'}{Above}
        \Pf{}{}{\quad\Config{\Names}{\Store}{\Procs,p:E[e]} ->
          \Config{\Names'}{\Store}{\Procs,\Procs',p:E[e']}}{By rule local}
