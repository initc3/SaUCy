...
%        \Pf{}{}{\qquad\exists~\Procs', p', q' \in \Sigma~\textrm{s.t.}~\Config{\Names}{\Store}{\Procs',
%            \ProcNm{p'} E_1[R[ \eLetRd{\eChan{c_1}}{x}{e}] ], \ProcNm{q'} E_2[
%              \eWr{\eChan{c_2}}{v}]} --->}{}
%        \Pf{}{}{\qquad\quad\Config{\Names}{\Store}{\Procs', \ProcNm{p'} E_1[ [\ePair{!v}{\eChan{c_1}}{\wm}/x]e], \ProcNm{q'}
