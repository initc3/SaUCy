...
\Pf{}{}{\textbf{Subcase}~\exists\Config{\Names'}{\Store}{\Procs'}~\textrm{s.t.}~\Config{\Names}{\Store}{\Procs}->\Config{\Names'}{\Store}{\Procs'}}{}
        ...
        \Pf{}{}{\qquad\Config{\Names}{\Store}{\Procs, \ProcNm{p} E[R[
          ...
          \Config{\Names}{\Store}{\Procs, \ProcNm{p} E[
              [\ePair{!v}{\eChan{c_1}}{\wm}/x]e]}~\textrm{or}}{}
  ...
  \item[] \textbf{Case}
    ...
    \begin{llproof}
      ...
      \Pf{}{}{\quad\PrTy(\pi) = \{ U_r \mid r:e \in \pi\} = U_{\pi},~\PrTy(p) =
        U_{p},~\PrTy(q) = U_{q}}{By assumption}
      ...
      \Pf{}{}{\quad\textrm{the position of}~\mathcal{D}_1'~\textrm{corresponds to
          position of}~\mathcal{D}_1~\textrm{in}~E_1}{By assumption}
      ...
      \Pf{}{}{\quad\textrm{the position of}~\mathcal{D}_2'~\textrm{corresponds to
          position of}~\mathcal{D}_2~\textrm{in}~E_2}{By assumption}

      \Pf{\Delta_1';\Gamma_1'}{|-}{\ePair{!v}{\eChan{c_1}}{\wm}/x]e : V_1'}{By Lemma~\ref{lem:sub-aff}}

      \Pf{\Delta_2';\Gamma_2'}{|-}{\eUnit : \tyUnit }{By inversion (unit)}

      \Pf{\Delta_1,\Delta_1';\Gamma_1,\Gamma_1'}{|-}{E_1[ [\ePair{!v}{\eChan{c_1}}{\wm}/x]e] : V_1}{By
      ...
      \Pf{\ChTy'}{|-}{\Config{\Names}{\Store}{\Procs, \ProcNm{p} E_1[ [\ePair{!v}{\eChan{c_1}}{\wm}/x]e], \ProcNm{q}
