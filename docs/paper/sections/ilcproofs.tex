    ...
    \item[] \textbf{Case}
      ...
      \begin{llproof}
        \Pf{}{}{\JCterm{\Config{\Names}{\Store}{p:e}}~\textrm{or}~\exists
          \Config{\Names'}{\Store}{\Procs',p:e'}~\textrm{s.t.}~\Config{\Names}{\Store}{p:e}->\Config{\Names'}{\Store}{\Procs',p:e'}}{By
          i.h.}        
        ...
        \Pf{}{}{\textbf{Subcase}~\exists
          \Config{\Names'}{\Store}{p:e'}~\textrm{s.t.}~\Config{\Names}{\Store}{p:e}->\Config{\Names'}{\Store}{p:e'}}{\todo{Check}}
        \Pf{}{}{\quad e -> e'}{Above}
...
\Pf{}{}{\textbf{Subcase}~\exists\Config{\Names'}{\Store}{\Procs'}~\textrm{s.t.}~\Config{\Names}{\Store}{\Procs}->\Config{\Names'}{\Store}{\Procs'}}{}
        \Pf{}{}{\quad\Config{\Names}{\Store}{\Procs,p:e} ->
          \Config{\Names'}{\Store}{\Procs',p:e}}{By Lemma~\ref{lem:par}~\todo{check}}
...
To state preservation on configurations, we start with several auxiliary
...
\begin{lemma}[Replacement (Evaluation Contexts)]\label{lem:replacement}
  If
  \begin{enumerate}
  \item $\mathcal{D}$ is a derivation of $\Delta_1,\Delta_2;\Gamma_1,\Gamma_2 |- E[e] : U$ (written $\mathcal{D} :: \Delta;\Gamma |- e : U$),
  \item $\mathcal{D}'$ is a subderivation of $\mathcal{D}$ (written
    $\mathcal{D}' \sqsubseteq \mathcal{D}$) concluding $\Delta_2; \Gamma_2 |- e : V$,
...
For brevity, we write ``$\mathcal{D}$ is a derivation of $\Delta;\Gamma |- e : U$'' as
$\mathcal{D} :: \Delta;\Gamma |- e : U$. Finally, Lemmas~\ref{lem:sub-int}
and~\ref{lem:sub-aff} show that typing of terms is preserved by substitution.
...
\begin{proof}
  ...
  \item[] \textbf{Case}
    ...
    \begin{llproof}
      ...
      \Pf{\ChTy}{|-}{\Config{\Names,q}{\Store}{\Procs} : \PrTy_{\pi}}{Above \todo{check}}
      ...
      \Pf{}{}{\ChTy' = \ChTy~\textrm{and}~\PrTy' = \PrTy, q : U_q}{Suppose}      

      \Pf{\ChTy'}{|-}{\Config{\Names,q}{\Store}{\Procs, \ProcNm{q} \proc{e_1},
          \ProcNm{p} \proc{E[e_2]}} : \PrTy_{\pi}, q : U_q, p : U_p = \PrTy'}{By
        rule cons}
    \end{llproof}
  ...
  \item[] \textbf{Case}
    ...
    \begin{llproof}
      ...
      \Pf{}{}{\quad \mathcal{D} :: \Delta_1,\Delta_2;\Gamma_1,\Gamma_2|- \proc{E[ \eNu{(x_1, x_2)}{e} ]} :U_{p} =
        \PrTy(p)}{Assumption}
      ...
      \Pf{\emptyctxt;\emptyctxt}{|-}{c_1 : \tyRd{S}}{Above \todo{check}}            
  ...
  \item[] \textbf{Case}
    ...
    \begin{llproof}
      ...
      \Pf{\emptyctxt;\emptyctxt}{|-}{v : S}{By inversion on wr \todo{check}}
      ...
      \Pf{\Delta_2';\Gamma_2'}{|-}{\eUnit : \tyUnit }{By inversion on unit \todo{check}}
      ...
      \Pf{\ChTy'}{|-}{\Config{\Names}{\Store}{\Procs, \ProcNm{p} E_1[ [\ePair{!v}{\eChan{c_1}}{1}/x]e], \ProcNm{q}
        E_2[ \eUnit ]} : \PrTy_{\pi}, p:U_p, q:U_q = \PrTy'}{By rule cons}
    \end{llproof}
  ...
  \item[] \textbf{Case}
    ...
    \begin{llproof}
      ...
      \Pf{}{}{\quad\textrm{s.t.}~\PrTy_{\pi} = \{
        \PrTy(x) \mid x:e \in \pi\},}{}
      \Pf{}{}{\quad \mathcal{D}_p :: \Delta_1,\Delta_1';\Gamma_1,\Gamma_1'|- \proc{E_1[\eChoicee{c_1}{x_1}{e_1}{c_2}{x_2}{e_2}]} :U_{p} =
        \PrTy(p),~\textrm{and}}{}
      \Pf{}{}{\quad \mathcal{D}_q :: \Delta_2,\Delta_2';\Gamma_2,\Gamma_2'|- \proc{E_2[ \eWr{v}{\eChan{c}}]} :U_{q} =
        \PrTy(q)}{Assumption}
      ...
      \Pf{\Delta_2';\Gamma_2'}{|-}{\eUnit : \tyUnit }{By inversion on unit}
...
\begin{proof}
   ...
   \item[] \textbf{Case} choice-write interaction \todo{?}
     \begin{itemize}[leftmargin=*]
       \item[] In the case that either step uses \Rule{cw}, we rely on lemmas
         \ref{lem:UniqueWriter} and \ref{lem:UniqueReader} to show that both
         steps use \Rule{cw}, and that the reader-writer process pair is unique.
     \end{itemize}     
   \end{itemize}
\end{proof}
\end{theorem}
