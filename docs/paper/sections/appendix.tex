...
%
\Infer{a-let!}
{\Delta_1; \Gamma |- e_1 : \tyBang{A} ; \Delta_2\\\\
\Delta_2; \Gamma, x:A |- e_2 : U ; \Delta_3}
{\Delta_1; \Gamma |- \eLetBang{x}{e_1}{e_2} : U ; \Delta_3}
%
\and
%
\Infer{a-abs}
...
{\Delta ; \Gamma |- \eLAM{x}{e} : X \multimap U ; \Delta}
%
\and
%
\Infer{a-app}
...
{\Delta_1 ; \Gamma |- \keyword{rd}(e) : \tyTensor{\tyBang{S}}{\tyRd{S}}; \Delta_2, \wrtok}
%
\and
%
\Infer{a-fork}
