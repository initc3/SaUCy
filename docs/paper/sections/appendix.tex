...
{\Delta_1; \Gamma |- \ePair{e_1}{e_2} : \tyProdd{\omega}{U_1}{U_2} ; \Delta_3}
%
\and
%
\Infer{a-inj}
...
{\Delta; \Gamma |- \eFixx{\omega}{x}{e} : A -> A ; \Delta}
%
\and
%
\Infer{a-afix}
{\Delta_1, x : X \multimap X; \Gamma |- e : X \multimap X ; \Delta_2}
{\Delta_1; \Gamma |- \eFixx{1}{x}{e} : X \multimap X ; \Delta_2}
%
\and
%
\Infer{a-let}
...
{\Delta ; \Gamma |- \eLamm{\omega}{x}{e} : A -> B ; \Delta}
%
\and
%
\Infer{a-lolli}
...
{\Delta_1 ; \Gamma |- \eRd{e} : \tyProdd{1}{\tyBang{S}}{\tyRd{S}}; \Delta_2, \wrtok}
%
\and
%
\Infer{a-fork}
