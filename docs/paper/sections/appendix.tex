...
{\Delta_1; \Gamma |- \eLet{\pi}{x}{e_1}{e_2} : \Delta_3; \Gamma; B}
%
\and
%
\Infer{a-unbang}
...
{\Delta ; \Gamma |- \eLam{1}{x}{e} : \Delta; \Gamma; \tyArr{A}{\footnotesize m}{B}}
%
\and
%
\Infer{a-app}
...
{\Delta_1; \Gamma |- \eApp{e_1}{e_2}{\pi} : \Delta_3; \Gamma; B}
%
\and
%
\Infer{a-nu}
...
{\Delta_1, \Delta_2; \Gamma |- \ePair{e_1}{e_2}{\infty} : \Delta_3 ; \Gamma ; \tyTensor{X_1}{X_2}}
%
\and
%  
\Infer{a-asplit}
...
{\Delta_1; \Gamma |- \eSplit{e_1}{x_1}{x_2}{e_2}{\infty} : \Delta_3; \Gamma; Y}
%
\and
%
\Infer{a-afix}
{\Delta_1, x : \tyLolli{X}{\footnotesize m}{X}; \Gamma |- e : \Delta_ 2 ; \Gamma ; \tyLolli{X}{\footnotesize m}{X}}
{\Delta_1; \Gamma |- \eFix{\infty}{x}{e} : \Delta_2 ; \Gamma ; \tyLolli{X}{\footnotesize m}{X}}
%
\and
\Infer{a-lolli}
{\Delta_1,x:X ; \Gamma |- e : \Delta_2 ; \Gamma ; Y}
{\Delta_1 ; \Gamma |- \eLam{\infty}{x}{e} : \Delta_2 ; \Gamma ; \tyLolli{X}{\footnotesize m}{Y}}
%
\and
%
\Infer{a-aapp}
...
{\Delta_1; \Gamma |- \eApp{e_1}{e_2}{\pi} : \Delta_3; \Gamma; Y}
\end{mathpar}
