...
{\Delta_1; \Gamma |- \ePair{e_1}{e_2} : \tyProd{A_1}{A_2} ; \Delta_3}
%
\and
%
\Infer{a-inj}
...
%
\Infer{a-split}
{\Delta_1; \Gamma |- e_1 : \tyProd{A_1}{A_2} ; \Delta_2\\\\
\Delta_2; \Gamma,x_1:A_1, x_2: A_2 |- e : B ; \Delta_3}
{\Delta_1; \Gamma |- \eSplit{e_1}{x_1}{x_2}{e_2} : B ; \Delta_3}
%
\and
%  
\Infer{a-case}
{\Delta_1; \Gamma |- e : \tySum{A_1}{A_2} ; \Delta_2\\\\
\Delta_2; \Gamma,x_1:A_1 |- e_1 : B ; \Delta_3\\\\
\Delta_2; \Gamma,x_2:A_2 |- e_2 : B ; \Delta_3}
{\Delta_1; \Gamma |- \eCase{e}{x_1}{e_1}{x_2}{e_2} : B ; \Delta_3}
%
\and
%
\Infer{a-get}
...
%
\Infer{a-fix}
{\emptyctxt; \Gamma,x : A -> A |- e : A -> A ; \emptyctxt}
{\Delta; \Gamma |- \eFix{x}{e} : A -> A ; \Delta}
%
\and
%
\Infer{a-let}
{\Delta_1; \Gamma |- e_1 : A ; \Delta_2\\\\
\Delta_2; \Gamma, x:A |- e_2 : B ; \Delta_3}
{\Delta_1; \Gamma |- \eLet{x}{e_1}{e_2} : B ; \Delta_3}
%
\and
%
\Infer{a-let!}
{\Delta_1; \Gamma |- e_1 : A ; \Delta_2\\\\
\Delta_2; \Gamma, x:A |- e_2 : B ; \Delta_3}
{\Delta_1; \Gamma |- \eLetBang{x}{e_1}{e_2} : B ; \Delta_3}
%
\and
%
\Infer{a-abs}
{\emptyctxt ; \Gamma, x:A |- e : B ; \emptyctxt}
{\Delta ; \Gamma |- \eLam{x}{e} : A -> B ; \Delta}
%
\and
%
\Infer{a-app}
{\Delta_1; \Gamma |- e_2 : A ; \Delta_2\\\\
\Delta_2; \Gamma |- e_1 : A -> B ; \Delta_3}
{\Delta_1; \Gamma |- \eApp{e_1}{e_2} : B ; \Delta_3}
%
\and
%
\Infer{a-nu}
...
\judgbox{\Delta_{in} ; \Gamma |- e : X ; \Delta_{out}}{~~Under input contexts $\Delta_{in}$ and
  $\Gamma$, expression~$e$ has affine type $X$ and output context $\Delta_{out}$.}
\begin{mathpar}
\Infer{a-avar}
{\Delta(x) = X}
{\Delta; \Gamma |- x : X ; \Delta}
%
\and
%
\Infer{a-bang}
...
{\Delta_1, \Delta_2; \Gamma |- \eLPair{e_1}{e_2} : \tyTensor{X_1}{X_2} ; \Delta_3}
%
\and
%  
\Infer{a-asplit}
{\Delta_1; \Gamma |- e_1 : \tyTensor{X_1}{X_2} ; \Delta_2\\\\
\Delta_2,x_1:X_1, x_2: X_2; \Gamma |- e : Y ; \Delta_3}
{\Delta_1; \Gamma |- \eLsplit{e_1}{x_1}{x_2}{e_2} : Y ; \Delta_3}
%
\and
%
\Infer{a-afix}
{\Delta_1, x : X \multimap X; \Gamma |- e : X \multimap X ; \Delta_2}
{\Delta_1; \Gamma |- \eLfix{x}{e} : X \multimap X ; \Delta_2}
%
\and
\Infer{a-lolli}
{\Delta_1,x:X ; \Gamma |- e : Y ; \Delta_2}
{\Delta_1 ; \Gamma |- \eLAM{x}{e} : X \multimap Y ; \Delta_2}
%
\and
%
\Infer{a-aapp}
{\Delta_1; \Gamma |- e_2 : X ; \Delta_2\\\\
\Delta_2; \Gamma |- e_1 : X \multimap Y ; \Delta_3}
{\Delta_1; \Gamma |- \eLapp{e_1}{e_2} : Y ; \Delta_3}
\end{mathpar}
