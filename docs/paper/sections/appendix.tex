...
{\Delta_1; \Gamma |- \ePair{e_1}{e_2}{\pi} : U_1 \times_{\pi}U_2 -| \Delta_3}
%
\and
%
\Infer{inj}
...
{\Delta_1 ; \Gamma |- \eInj{\pi}{i}{e} : U_1 +_{\pi} U_2 -| \Delta_2}
%
\and
%
\Infer{split}
...
%  
\Infer{case}
{\Delta_1; \Gamma |- e : U_1 +_{\pi} U_2 -| \Delta_2\\\\
...
%
\Infer{ifix}
{\emptyctxt; \Gamma,x : \tyArr{A}{\footnotesize m}{U} |- e : \tyArr{A}{\footnotesize m}{U} -| \Delta_2}
{\Delta_1; \Gamma |- \eFix{\infty}{x}{e} : \tyArr{A}{\footnotesize}{U} -| \Delta_2}
%
\and
%
\Infer{afix}
{\Delta_1,x : \tyLolli{X}{\footnotesize m}{U}; \Gamma |- e : \tyLolli{X}{\footnotesize m}{U} -| \Delta_2}
{\Delta_1; \Gamma |- \eFix{1}{x}{e} : \tyLolli{U}{\footnotesize m}{U} -| \Delta_2}
%
\and
%
\Infer{let}
{\Delta_1; \Gamma |- e_1 : U_1 -| \Delta_2\\
[\Delta_2; \Gamma], x:U |- e_2 : V_1 -| \Delta_3}
...
%
\Infer{iabs}
{\emptyctxt ; \Gamma, x:A |- e : U -| \Delta_2}
{\Delta_1 ; \Gamma |- \eLam{\infty}{x}{e} : \tyArr{A}{\footnotesize m}{U} -| \Delta_1}
%
\and
%
\Infer{aabs}
{\Delta_1, x:X ; \Gamma |- e : U -| \Delta_2}
{\Delta_1 ; \Gamma |- \eLam{1}{x}{e} : \tyLolli{X}{\footnotesize m}{U} -| \Delta_1}
%
\and
%
\Infer{iapp}
{\Delta_1; \Gamma |- e_2 : A -| \Delta_2\\\\
\Delta_2; \Gamma |- e_1 : \tyArr{A}{\footnotesize m}{U} -| \Delta_3}
...
\Delta_2; \Gamma |- e_1 : \tyLolli{X}{\footnotesize m}{U} -| \Delta_3}
{\Delta_1; \Gamma |- \tyLolli{e_1}{1}{e_2} : U -| \Delta_3}
%
\and
%
\Infer{nu}
{\Delta_1, x_1: \tyRd{A} ; \Gamma, x_2 : \tyWr{A} |- e : U -| \Delta_2}
{\Delta_1; \Gamma |- \eNu{(x_1, x_2)}{e} : U -| \Delta_2}
%
\and
%
\Infer{wr}
{\Delta_1; \Gamma |- e_1 : A -| \Delta_2\\
\Delta_2; \Gamma |- e_2 : \tyWr{A} -| \Delta_3}
{\Delta_1; \Gamma|- \eWr{e_1}{e_2} : \tyUnit -| \Delta_3}
%
\and
%
\Infer{letrd}
{\Delta_1 ; \Gamma |- e_1 : \tyRd{A} -| \Delta_2 \\\\
\Delta_2,x_1:\tyBang{A},x_2:\tyRd{A} ; \Gamma |- e_2 : U -| \Delta_3}
{\Delta_1; \Gamma |- \eLetRd{x_1}{x_2}{e_1}{e_2} : U -| \Delta_3}
%
\and
%
\Infer{fork}
