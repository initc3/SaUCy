...
guarantee security in a standalone setting (no composition guarantees). To our
knowledge, these have not been used for simulation-based proofs, but it would be
interesting to embed ILC into EasyCrypt or $\textnormal{F}^{*}$ in order to use
their tooling.
...
and give a concrete programming model. \todo{Abstract Cryptography~\cite{maurer2011abstract}.}
