...
\label{subsec:tools}
There are a variety of computer-aided tools for cryptographic analysis.
Among the symbolic tools include the NRL protocol
...
$\text{F}^{*}$~\cite{swamy2016dependent}.
Although the computational tools do not support message-passing concurrency,
it would be interesting to embed ILC into EasyCrypt or F* in order to use
its tooling. \todo{Expand.}
