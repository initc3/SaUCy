...
machines, but plenty of existing calculi are also cryptographically-flavored
...
sessions, so in our multiparty setting, ILC requires a more sophisticated type
system to achieve confluence.

\todo{Sequentiality in the $\pi$-calculus.}
