...
The IITMs model~\cite{kusters2006simulation,camenischiuc} aims to provide a
simpler notion of polynomial time. Our work is orthogonal, but comes with the
benefit of flexibility. For example, our type system subsumes their notion of
