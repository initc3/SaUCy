\begin{abstract}
  ...
  either by using an symbolic model (thereby ruling out computational reduction proofs),
  ...
  We demonstrate the use of SaUCy by working through an instantiation
  of UC-secure commitments from the literature, defining a composition
  operator and proving its associated theorem, as well as examining
