\begin{abstract}
  ...
  reasoning about cryptographic security reductions.  We use ILC to develop our
  implementation of UC, called SaUCy.  To demonstrate the use of SaUCy, we work
  through an instantiation of UC-secure commitments from the literature, define
  a composition operator and proving its associated theorem, as well as examine
