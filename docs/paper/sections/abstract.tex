\begin{abstract}
  ...
  Interactive Lambda Calculus (ILC). In particular, ILC faithfully captures the
  ...
  other words, \emph{well-typed ILC programs are expressible as ITMs.} And being
  a faithful embedding of ITMs is crucial---it is necessary for computational
  security proofs to go through. \todo{Discuss SaUCy.}
\end{abstract}
