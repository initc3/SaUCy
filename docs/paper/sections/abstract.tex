\begin{abstract}
  ...
  simplified implementation of UC, called SaUCy.  To demonstrate the use of
  SaUCy, we work through an instantiation of UC-secure commitments from the
  literature, define a composition operator and proving its associated theorem,
  as well as examine a subtle definitional issue involving race conditions.
\end{abstract}
