...
%
\Infer{fix}
{\Delta; \Gamma, x : \tyArr{A}{\footnotesize m}{A} |- e : A}
{\Delta; \Gamma |- \eFix{x}{e} : A}
%
\and
%
\Infer{lfix}
{\Delta, x : \tyLolli{X}{\footnotesize m}{X}; \Gamma |- e : X}
{\Delta; \Gamma |- \eFix{x}{e} : X}
%
\and
%
\Infer{let}
...
\end{mathpar}
\judgbox{\Delta ; \Gamma |- e : X |> m}{~~Under $\Delta$ and $\Gamma$, expression~$e$ has type $X$ and mode $m$.}
\begin{mathpar}
\Infer{lvar}
{\Delta(x) = X}
{\Delta; \Gamma |- x: X}
