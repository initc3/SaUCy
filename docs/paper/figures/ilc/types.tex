...
%%
\Infer{fix}
{[\emptyctxt; \Gamma],x : U {->}_{\ell} V |- e : U {->}_{\ell} V -| \emptyctxt}
{\Delta; \Gamma |- \eFixx{\ell}{x}{e} : U {->}_{\ell} V -| \Delta}
%\Infer{fix}
...
{\Delta ; \Gamma |- \eLamm{\wm}{x}{e} : A {->}_{\wm} U -| \Delta}
%\Infer{wabs}
...
\Infer{wapp}
{\Delta_1; \Gamma |- e_2 : U -| \Delta_2\\\\
\Delta_2; \Gamma |- e_1 : U {->}_{\wm} V -| \Delta_3}
{\Delta_1, \wrtok; \Gamma |- \eApp{e_1}{e_2}{\wm} : V -| \Delta_3}
%
\and
%
\Infer{nu}
