...
%
\Infer{lolli}
{x : X; \Gamma |- e : U ; \Delta_2}
{\Delta_1 ; \Gamma |- \eLamm{1}{x}{e} : X \multimap U ; \Delta_1}
%
\and
%
\Infer{wabs}
{\wrtok; \Gamma |- e : U ; \Delta_2}
{\Delta_1 ; \Gamma |- \eLamm{\omega}{\eUnit}{e} : \tyArr{\mathbbm{1}}{\omega}{U} ; \Delta_1 + \wrtok ? \Delta_2}
%
\and
%
\Infer{app}
...
%
\Infer{wapp}
{\Delta_1, \wrtok; \Gamma |- e_2 : \mathbbm{1} ; \Delta_2\\\\
\Delta_2; \Gamma |- e_1 : \tyArr{\mathbbm{1}}{\omega}{V} ; \Delta_3}
{\Delta_1, \wrtok; \Gamma |- \eApp{e_1}{e_2}{\omega} : V ; \Delta_3}
%
\and
%
\Infer{nu}
