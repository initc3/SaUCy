...
{\Delta ; \Gamma |- \eLamm{}{x}{e} : A -> U -| \Delta}
%
\and
%
\Infer{wabs}
{\wrtok ; \Gamma, x:A |- e : U -| \emptyctxt}
{\Delta ; \Gamma |- \eLamm{\wm}{x}{e} : A \twoheadrightarrow U -| \Delta}
%\Infer{wabs}
...
\Delta_2; \Gamma |- e_1 : A \twoheadrightarrow U  -| \Delta_3}
...
{\Delta_1; \Gamma |- \eNu{(x_1, x_2)}{e} : A -| \Delta_2 \div (x_1: \tyRd{S})}
%
\and
%
\Infer{wr}
...
%\Delta_2,\wrtok, x_1 : \tyBang{S}, x_2 : \tyRd{S} ; \Gamma |- e_2 : U -| \Delta_3}
%{\Delta_1 ; \Gamma |- \eLetRd{x_1}{x_2}{e_1}{e_2} : U -| \Delta_3 \div (\wrtok, x_1 : \tyBang{S}, x_2 : \tyRd{S})}
%
\and
%
%\Infer{fork}
%{\Delta_1; \Gamma |- e_1 : U -| \Delta_3\\\\
%\Delta_2; \Gamma |- e_2 : V -| \Delta_4}
%{\Delta_1, \Delta_2; \Gamma |- \eFork{e_1}{e_2} : V -| \Delta_4}
%\Infer{fork}
%{\Delta_1; \Gamma |- e_2 : U -| \Delta_2\\\\
%\Delta_2 \div \wrtok; \Gamma |- e_1 : V -| \Delta_3}
%{\Delta_1; \Gamma |- \eFork{e_1}{e_2} : V -| \Delta_3}
\Infer{fork}
{\Delta_1; \Gamma |- e_1 : U -| \Delta_2\\\\
\Delta_2, \wrtok; \Gamma |- e_2 : V -| \Delta_3}
{\Delta_1, \wrtok; \Gamma |- \eFork{e_1}{e_2} : V -| \Delta_3}
%
\and
%
\Infer{choice}
