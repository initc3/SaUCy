...
{\Delta_1, \Delta_2; \Gamma |- \ePair{e_1}{e_2}{\pi} : \tyProd{A_1}{A_2}}
%
\and
%
\Infer{inj}
{i \in \{1, 2\}\\\\
\Delta; \Gamma |- e : A_i}
{\Delta ; \Gamma |- \eInj{\pi}{i}{e}  : \tySum{A_1}{A_2}}
%
\and
%
\Infer{split}
...
{\Delta_1, \Delta_2; \Gamma |- \eSplit{\pi}{e_1}{x_1}{x_2}{e_2} : B |> m}
%
\and
%
\Infer{case}
...
{\Delta_1, \Delta_2; \Gamma |- \eCase{\pi}{e}{x_1}{e_1}{x_2}{e_2} : B |> m}
%
\and
%
\Infer{fix}
{\emptyctxt; \Gamma, x : \tyArr{A}{\footnotesize m}{A} |- e : \tyArr{A}{\footnotesize m}{A}}
{\Delta; \Gamma |- \eFix{\pi}{x}{e} : \tyArr{A}{\footnotesize m}{A}}
%
\and
%
\Infer{let}
...
{\Delta_1, \Delta_2; \Gamma |- \eLPair{e_1}{e_2} : \tyTensor{X_1}{X_2}}
%
\and
%
\Infer{asplit}
