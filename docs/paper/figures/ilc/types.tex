...
%
\Infer{ifix}
{\emptyctxt; \Gamma,x : A -> U |- e : A -> U -| \emptyctxt}
{\Delta; \Gamma |- \eFixx{\infty}{x}{e} : A -> U -| \Delta}
%
\and
%
\Infer{afix}
{\Delta_1, x : X \multimap U ; \Gamma |- e : X \multimap U -| \Delta_2}
{\Delta_1; \Gamma |- \eFixx{1}{x}{e} : X \multimap U -| \Delta_2 \div (x : X \multimap U)}
%\Infer{fix}
