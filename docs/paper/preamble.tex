...
\newcommand*{\xdash}[1][3em]{\rule[0.5ex]{#1}{0.4pt}}
\newcommand{\sep}{\xdash[0.8em]\kern-.22em\raisebox{-.052ex}{$\mathsf{*}$}\ }
\newcommand{\wrhat}{\hat{\rule{0ex}{1.575ex}\wrtok}}
\newcommand{\wrtok}{\textcircled{\small{\wm}}}

\newcommand{\mc}[1]{\mathcal{{#1}}}
\newcommand{\todo}[1]{\emph{\hl{TODO:} {#1}}}
\newcommand{\saucy}{SaUCy\xspace}
\newcommand{\fstar}{$\text{F}^{*}$}
...
\newcommand{\eInj}[2]{\keyword{inj}_{\pi}^{#1}\Lparen#2\Rparen}
\newcommand{\eInjj}[3]{\keyword{inj}_{#1}^{#2}\Lparen#3\Rparen}
...
\newcommand{\eSplitt}[5]{\keyword{split}_{#1}\Lparen{#2},{#3}.{#4}.{#5}\Rparen}
...
\newcommand{\eLet}[3]{\keyword{let}_{\pi}\lparen{#2},{#1}.{#3}\Rparen}
\newcommand{\eLett}[4]{\keyword{let}_{#1}\lparen{#3},{#2}.{#4}\Rparen}
%\newcommand{\eLetRd}[4]{\eLett{\eLPair{#1}{#2}}{\eRd{#3}}{{#4}}}
\newcommand{\eLetBang}[3]{\keyword{let!}\ {#1} = {#2}\ \keyword{in}\ {#3}}
\newcommand{\eLam}[2]{\lambda{#1}.\,{#2}}
\newcommand{\eLamm}[3]{\lambda_{#1}\,{#2}.\,{#3}}
\newcommand{\eApp}[3]{\Lparen#1\,#2\Rparen_{#3}}
\newcommand{\eNu}[2]{\nu#1.\,#2}
\newcommand{\eWr}[2]{\keyword{wr}\Lparen{#1},{#2}\Rparen}
\newcommand{\eRd}[1]{\keyword{rd}\Lparen{#1}\Rparen}
\newcommand{\eLetRd}[3]{\keyword{rd}\Lparen{#1},{#2}.{#3}\Rparen}
\newcommand{\eFork}[2]{\ensuremath{#1 \xFork #2}}
\newcommand{\eChoice}[2]{\ensuremath{#1 \xChoice #2}}
\newcommand{\eChoicee}[6]{\keyword{ch}\Lparen{#1},{#2}.{#3},{#4},{#5}.{#6}\Rparen}
%\newcommand{\eChoicee}[6]{{#2}@{#1} => {#3} \xChoice {#4}@{#3} =>{#6}}
...
\newcommand{\xChoice}{\mathrel{\boxplus}}
\newcommand{\e}{\epsilon}
\newcommand{\Lparen}{\mathsf{(}}
\newcommand{\Rparen}{\mathsf{)}}
...
\newcommand{\Val}[1]{#1~\textbf{val}}

\newcommand{\Norm}[1]{#1~\textbf{norm}}

\newcommand{\Norw}[1]{#1~\textbf{\st{rw}}}
